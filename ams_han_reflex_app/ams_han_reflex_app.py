    ...
    return rx.hstack(
        ...
        rx.hstack(
            rx.box(
                ...
                height="18px",
                border_radius="6px",
                bg="linear-gradient(135deg, rgba(100, 116, 139, 0.18) 0%, rgba(100, 116, 139, 0.18) 60%, rgba(250, 204, 21, 0.50) 78%, rgba(249, 115, 22, 0.70) 90%, rgba(239, 68, 68, 0.92) 100%)",
                border="1px solid rgba(148, 163, 184, 0.28)",
            ),
            rx.text("Yellow → orange → red corner = more switch activity; red marks the busiest hours", size="2", color=rx.color("gray", 10)),
            spacing="2",
            align="center",
        ),
        spacing="4",
